...
public class ProductAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Picasso.get().load(productList.get(position).getImage()).into(holder.productImage, new Callback() {
            @Override
                                ...
                                if (productsList != null) {
                                    ...
                                    for (int i = 0; i < productsList.size(); i++) {
                                        ...
                                        if (productId.equals(product.getProductId())) {
                                            // Get the image URL to delete from Firebase Storage
    ...
    private void deleteImageFromFirebaseStorage(String imageUrl) {
        ...
        imageRef.delete().addOnSuccessListener(aVoid -> {
            ...
            Log.e("Firebase Storage", "Error deleting image: " + e.getMessage());
        });
    }
